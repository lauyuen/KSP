...
function visualTrackerDemoBobwNormTmpFlt2
...
Thr = 0.3; %55; %65; % Threshold for posterior differences
...
%                         DisplayedSpeed = DisplayedSpeed*10;
                        ...
                        if (TRAVELDISTS_VAR < 200^2)&(co_VAR < 200^2)&(ca_VAR < 200^2)&(co_VAR > 0)&(ca_VAR > 0) 
                            ...
                            line( [Centres(m,1)-Sq_W Centres(m,1)-Sq_W], [Centres(m,2)-Sq_H  Centres(m,2)+Sq_H ], 'Color', 'y', 'LineWidth',3)
                            line( [Centres(m,1)+Sq_W Centres(m,1)+Sq_W], [Centres(m,2)-Sq_H  Centres(m,2)+Sq_H ], 'Color', 'y', 'LineWidth',3)
                            line( [Centres(m,1)-Sq_W Centres(m,1)+Sq_W], [Centres(m,2)-Sq_H  Centres(m,2)-Sq_H ], 'Color', 'y', 'LineWidth',3)
                            line( [Centres(m,1)-Sq_W Centres(m,1)+Sq_W], [Centres(m,2)+Sq_H  Centres(m,2)+Sq_H ], 'Color', 'y', 'LineWidth',3)
